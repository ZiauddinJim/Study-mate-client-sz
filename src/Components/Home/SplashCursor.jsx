...
function SplashCursor({
    ...
    `;
      ...
      `
        ...
        function generateColor() {
            // Color A: #2663EB (blue)
            const colorA = { r: 38 / 255, g: 99 / 255, b: 235 / 255 };
            // Color B: #9333EA (purple)
            const colorB = { r: 147 / 255, g: 51 / 255, b: 234 / 255 };
            ...
            return {
                ...
                g: mix(colorA.g, colorB.g) * opacity,
                b: mix(colorA.b, colorB.b) * opacity,
            };
        }
